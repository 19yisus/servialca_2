<script>
    $(document).ready(function() {
        ...
        var ingreso = 0; // Valor predeterminado para renovaciones
        var egreso = 0; // Valor predeterminado para nuevos
        ...
        function crearGraficoRosquilla() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < resultado.data.length; i++) {
                        if (resultado.data[i].nota_IngresoEgreso == 1) {
                            ingreso++;
                        } else {
                            egreso++;
                        }
            ...
            const data = {
                labels: ['Ingreso: ' + ingreso, 'Egreso: ' + egreso],
                datasets: [{
                    label: '',
                    data: [ingreso, egreso],
        ...
        function refres() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    egreso = 0;
                    for (var i = 0; i < resultado.data.length; i++) {
                        if (resultado.data[i].nota_IngresoEgreso > 0) {
                            ingreso++;
                        } else {
                            egreso++;
                        }
