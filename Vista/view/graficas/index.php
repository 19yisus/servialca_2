    ...
    <div id="contenido">
        ...
        <div class="main-content">
            <div class="col-md-12 mx-auto row">
                <h3 class="text-center bg-dark py-2 text-light">Analisis de los
                    Movimientos del Sistema</h3>
                <div class="col-md-7">
                    ...
                    <div class="col-md-12 mx-auto py-5">
                        <h5 class="text-center">Géstion de Contratos</h5>
                        <table class="table table-sm table-hover table-striped" id="tabla">
                            <thead>
                                <tr>
                                    <th scope="col" class="text-center bg-danger
                                    text-light">N° de contrato</th>
                                    <th scope="col" class="text-center bg-danger
                                    text-light">Nombre del vendedor</th>
                                    <th scope="col" class="text-center bg-danger
                                    text-light">Sucursal</th>
                                    <th scope="col" class="text-center bg-danger
                                    text-light">Tipo de contrato</th>
                                    <th scope="col" class="text-center bg-danger
                                    text-light">Monto en $</th>
                                    <th scope="col" class="text-center bg-danger
                                    text-light">Monto en Bs</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
