                        ...
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
                                    <a href="#contrato" class="btn btn-success" data-toggle="modal">
                                        <i class="material-icons">&#xE147;</i> <span>Nuevo</span></a>
                                </div>
                            </div>
                        </div>
                        <table class="table table-striped table-hover" id="tablaContrato">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre</th>
                                    <th>Daño cosas</th>
                                    <th>Daño personas</th>
                                    <th>Fianza cuantitativa</th>
                                    <th>Asistencia legal</th>
                                    <th>A.P.O.V</th>
                                    <th>Muerte</th>
                                    <th>Invalidez</th>
                                    <th>Gastos medicos</th>
                                    <th>Grua y estacionamiento</th>
                                    <th>Estatus</th>
                                    <th>Opciones</th>
                                </tr>
                            </thead>
