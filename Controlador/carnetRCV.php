...
$Pdf->Image("../Vista/img/FONDO_CERTIFI.gif", 115, 28, 90, 60, "gif", "");
$Pdf->Image("../Vista/img/FONDO_CERTIFI_1.gif", 25, 28, 90,60, "gif", "");
$Pdf->Image("../Vista/img/FONDO_CERTIFI_2.gif", 30, 32, 25, 8, "gif", "");
...
$Pdf->Ln(1);
$Pdf->Cell(16, 7, "");
$Pdf->Image("../Vista/img/rubro.jpg", 85, 32, 25, 20);
$Pdf->Ln(6);
$Pdf->SetFont('Arial', 'B', 8); // Aumentar el tamaño de fuente a 8
$Pdf->Cell(17, 6, "");
