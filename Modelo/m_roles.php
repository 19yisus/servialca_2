...
class Rol extends Conexion
{
    ...
    {
        $sql = $this->conexion->prepare("SELECT * FROM roles WHERE roles_nombre = ?");
    ...
    {
        $sql = $this->conexion->prepare("INSERT INTO roles(roles_nombre,roles_estatus) VALUES (?,?)");
    ...
    {
        $sql = $this->conexion->prepare("UPDATE roles SET roles_nombre = ? WHERE roles_id = ?");
    ...
    {
        $sql = $this->conexion->prepare("UPDATE roles SET roles_estatus = ? WHERE roles_id = ?");
    ...
    {
        $sql = $this->conexion->prepare("SELECT * FROM roles WHERE roles_id = ?");
